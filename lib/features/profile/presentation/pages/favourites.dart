...
import 'package:tressy/features/widgets/custom_search_field.dart';
...
class _FavouritesState extends State<Favourites> {
  ...
  List<bool> isFavouriteList = List.generate(5, (index) => false);

  @override
  void initState() {
    searchController = TextEditingController();
    isFavouriteList[0] = true;
    super.initState();
  }
              ...
              child: salonList.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final favouriteData = salonList[index];

                        return Padding(
                          padding: const EdgeInsets.only(bottom: 15),
                          child: SalonContainerHorizontal(
                            salonData: favouriteData,
                            itemIndex: index,
                            isMaps: false,
                            onTap: () {},
                            favouriteOnTap: () {},
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.star, color: AppColors.ratingYellowDark, size: 16),
                ...
                Row(
                  children: [
                    const Icon(Icons.location_on, size: 14, color: AppColors.circleGreyColor),
