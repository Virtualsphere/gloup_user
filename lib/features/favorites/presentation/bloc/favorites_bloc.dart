...
class FavoritesBloc extends Bloc<FavoritesEvent, FavoritesState> {
  ...
  Future<void> _onToggleFavorite(
    ...
    print('🔍 ToggleFavorite: storeId=${event.storeId}, currentIsFavorite=${event.currentIsFavorite}');
    print('🔍 Current optimistic updates: ${state.optimisticUpdates}');
    ...
    print('🔍 currentValue=$currentValue (hasOptimistic=$hasOptimistic), newValue=$newValue');
    ...
    result.fold(
      (failure) {
        ...
        print('🔍 Failed - reverting optimistic update');
      ...
      (favoriteEntity) {
        ...
        print('🔍 Success - keeping optimistic update until data refreshes');
