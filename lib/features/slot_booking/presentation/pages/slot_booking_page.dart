...
class _SlotBookingPageState extends State<SlotBookingPage> {
  ...
  Widget _buildSalonInfoCard(BuildContext context, bool isDarkMode) {
    final salonName = widget.bookingData!['salonName'] as String? ?? 'N/A';
    final salonImage = widget.bookingData!['salonImage'] as String?;
    final rating = widget.bookingData!['rating'] as double? ?? 0.0;
    final reviewCount = widget.bookingData!['reviewCount'] as int? ?? 0;
    final gender = widget.bookingData!['gender'] as String? ?? 'N/A';
    final address = widget.bookingData!['address'] as String? ?? 'N/A';
    final isPremium = widget.bookingData!['isPremium'] as bool? ?? false;
